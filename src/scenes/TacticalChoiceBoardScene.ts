...
/**
 * 0.1.27 keeps 0.1.26 board/leaderboard presentation intact and only replaces
 * the Card action entry point so tactical cards can collect an explicit player choice
 * before the host-authoritative play_card intent is submitted.
 */
