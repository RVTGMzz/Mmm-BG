 ...
 * - Rectangular UI panels/buttons are visually replaced by rounded equivalents while
 *   their original Rectangle objects remain as transparent hit areas.
...
export class CareerMinigameBoardScene065 extends CareerMinigameBoardScene064 {
  ...
  private isUiRectangle065(rectangle: Phaser.GameObjects.Rectangle): boolean {
    ...
    if (rectangle.depth >= 500) return true;
    let parent = rectangle.parentContainer;
    while (parent) {
