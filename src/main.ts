...
import { PartyMechanicsBoardScene } from './scenes/PartyMechanicsBoardScene';
...
const config: Phaser.Types.Core.GameConfig = {
  ...
  scene: [LocalLobbyScene, SetupScene, PartyMechanicsBoardScene, BoardScene, NetworkBoardScene],
  dom: {
