...
import { CareerMinigameBoardScene040 } from './scenes/CareerMinigameBoardScene040';
...
const config: Phaser.Types.Core.GameConfig = {
  ...
  scene: [LocalLobbyScene, SetupScene, TurnOrderScene, CareerMinigameBoardScene040, BoardScene, NetworkBoardScene],
  dom: {
