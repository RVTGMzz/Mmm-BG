...
export const MEMEME_BUILD = {
  ...
  boardBadge: `PLAYTEST ${version} • GLOBAL CINEMATIC OWNERSHIP + TOKEN BADGE GUARD`,
  artifactName: `mememe-playtest-${version}-global-cinematic-token-badge`,
} as const;
