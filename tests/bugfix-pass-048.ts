...
assert(dice0701.includes('extends TurnOrderScene048'),'0.1.70.1 Roll For Order layer must retain the validated 0.1.48 authority ceremony');
assert(dice07044.includes('extends TurnOrderScene0701')); assert(!dice07044.includes('submitRoll(')); assert(!dice07044.includes('Math.random'));
