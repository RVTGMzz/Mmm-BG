...
assert.match(board, /findNamedContainer069\('job-detail-modal'\)/);
assert.match(board, /MatchPresentationLayer owns the canonical Job card/);
assert.match(board, /copy\.includes\('job xuất hiện'\)/);
