...
assert.match(splash, /assets\/mememe-logo-official\.webp\?v=canonical-1024-0693/);
assert(!splash.includes("assets/mememe-logo.webp"), 'splash must never use the broken 500x500 export again');
...
console.log('[first-impression-069] PASS canonical 1024 logo + presentation-actor HUD + leak-free Job result + reversible pre-game setup');
